...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="//script.auction.co.kr/style/css/renewal/reset.css">
	<link rel="stylesheet" type="text/css" href="//script.auction.co.kr/style/css/renewal/locbar.css">
	<link rel="stylesheet" type="text/css" href="//script.auction.co.kr/style/css/renewal/layout.css">
...
<script type="text/javascript" src="//script.auction.co.kr/arche.main.js"></script>
...
<script type="text/javascript">
    ...
    System.loadFile("//script.auction.co.kr/common/jquery.lazyload.js");
    System.loadFile("//script.auction.co.kr/listing/arche.search.include.js");
    System.loadFile("//script.auction.co.kr/sell/favoriteitem.js");
    //-->
</script>
<script type="text/javascript" src="//script.auction.co.kr/listing/arche.search.slotupdatemanager.js"></script>
<script type ="text/javascript" language="javascript">
    var usedItemfilter = {};
    usedItemfilter.CurrentSortBy = 45
    usedItemfilter.SortByNewlyListed = 45
    usedItemfilter.SortByEndingSoonest = 1
</script>
<!-- header -->	
