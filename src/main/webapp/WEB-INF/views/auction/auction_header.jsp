                    ...
                    <div class="row">
                        ...
                        <div id="test_area">
                            <ul id="test_cates">
                                ...
                                <li id="clothes"><a href="auction_list">의류</a></li>
                                <li id="acc"><a href="auction_list">악세서리</a></li>
                            </ul>
                            <ul id="test_clos">
                                <h3>의류</h3>
                                <li><a href="auction_list">남성의류</a></li>
                                <li><a href="auction_list">여성의류</a></li>
                            </ul>
                            <ul id="test_accs">
                                <h3>악세서리</h3>
                                <li><a href="auction_list">시계/쥬얼리</a></li>
                                <li><a href="auction_list">패션 악세서리</a></li>
                            </ul>
                        </div>
                        <!-- // 메뉴 호버 -->
                    </div>
