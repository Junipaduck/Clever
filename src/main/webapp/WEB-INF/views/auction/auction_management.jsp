	...
	<header>
        ...
        <div id="main_content">
            ...
            <nav class="content_nav">
                <a href="auction_upload">경매등록</a>
                <a href="auction_management" class="active">경매관리</a>
                        ...
                        <tr>
                            ...
                            <td>
                                <ul class="goods_status_show">
                                    <li class="show"><span>경매중</span><span class="gray_arrow"></span></li>
                                    <div>
                                        <li class="option">경매중</li>
                                        <li class="option">경매완료</li>
                                    </div>
                                </ul>
                            </td>
