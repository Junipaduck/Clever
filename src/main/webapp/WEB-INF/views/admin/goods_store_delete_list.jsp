...
<script type="text/javascript">
	function deleteGoods(goods_idx){
		if(confirm("상품을 삭제하시겠습니까?")){
			alert("삭제 성공!");
			location.href = "deleteGoodsPro.ad?goods_idx=" + goods_idx
			return true;
		} else {
			alert("삭제 실패!");
			return false;
                                        ...
                                        <tbody>
                                        	<c:forEach items="${goodsList }" var="goodsList">
	                                            <tr>
	                                                ...
	                                                <td>
	                                                	<input type="hidden" name="goods_idx" value="${goodsList.goods_idx }">
	                                                	<form action="deleteGoodsPro.ad">
	                                                		<button type="button" class="btn btn-primary" onclick="deleteGoods('${goodsList.goods_idx}')">삭제하기</button>
	                                                	</form>
	                                                </td>
	                                            </tr>
                                        	</c:forEach>
