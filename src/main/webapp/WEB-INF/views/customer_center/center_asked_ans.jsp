		...
		<form action="adminAskedFormPro.ad" name="adminAskedFormPro" method="post">
			...
			<div class="btn_submit_area">
		        <div class="inner_submit" >
		            <input type="submit" value="답변등록" style="height: 3.5rem; width: 10rem; color: rgb(255, 255, 255); font-size: 20px; border: none; background: rgb(255, 80, 88); position: relative; margin-top: 20px; margin-left: 426px;">
		        </div>
	    	</div>
		</form>
