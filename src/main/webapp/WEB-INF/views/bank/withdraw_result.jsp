                ...
                <!-- form 시작 -->
                        <div class="card" style="width: 900px;margin: auto;">
                            <div class="card-header">
                                <h4 class="card-title">출금이체결과</h4>
                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="goodsRegisterPro.ad" method="post">
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">요청일시</label>
                                            <div class="col-sm-10">
                                            	<input type="text" class="form-control" value="${result.api_tran_dtm }" readonly="readonly">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">출금계좌번호</label>
                                            <div class="col-sm-10">
                                            	<input type="text" class="form-control" value="${result.account_num_masked }" readonly="readonly">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">예금주명</label>
                                            <div class="col-sm-10">
                                            	<input type="text" class="form-control" value="${result.account_holder_name }" readonly="readonly">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">출금금액</label>
                                            <div class="col-sm-10">
                                            	<input type="text" class="form-control" value="${result.tran_amt }" readonly="readonly">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">출금가능금액</label>
                                            <div class="col-sm-10">
                                            	<input type="text" class="form-control" value="${result.wd_limit_remain_amt }" readonly="readonly">
                                            </div>
                                        </div>
                                    </form>
                                </div>
