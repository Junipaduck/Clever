...
<script type="text/javascript">
	...
	function payProduct(){
		    window.open("product_bank_userInfo?product_idx=${param.product_idx}&product_price=${param.product_price}&member_id=${param.member_id}&product_subject=${param.product_subject}", "바로구매새창", "width=800, height=1200" );
	}
